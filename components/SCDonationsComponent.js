...
class SCDonations extends Component {
    ...
    render() {
        ...
        let counter = this.props.seacreatures.seacreatures.filter(
            seacreature => this.props.seacreatureDonations.includes(seacreature.id)
        )
        console.log(counter.length / 40);
        let progress = parseFloat((counter.length / 40).toFixed(2));
                    ...
                    <View style={styles.modal}>
                        ...
                        <View style={styles.modalView}>
                            ...
                            <View style={styles.modalProgress}>
                                ...
                                <Text style={styles.modalText}>Total number of seacreatures: 40</Text>

                                <Text style={styles.modalText}>You have donated {counter.length} out of 40.</Text>
                            </View>
